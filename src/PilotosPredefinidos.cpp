...
namespace PilotosPredefinidos {
    ...
    Unidade unidadeVazia; // Unidade vazia para inicialização
     ...
     Piloto PilotoFederacao = Piloto("Caso existam 2 ou mais cópias de \"Piloto da Federação\" no campo, cada unidade pilotada por \"Piloto da Federação\" recebe PV+15",
                                          unidadeVazia,
