...
namespace UnidadesPredefinidas {
     ...
     Unidade Gelgoog = Unidade(50, 50, 6, "Linha de producao em massa desenvolvida pelo Principado de Zeon em 0079, Seculo Universal. Criado para ser igual ou superar o RX-78-2 Gundam da Federacao da Terra, MS-14A Gelgoog portava armamentos de lazer, como o rifle de assalto de raios e a Naginata de raios", "tipo", "Gelgoog", false, 38, false);
